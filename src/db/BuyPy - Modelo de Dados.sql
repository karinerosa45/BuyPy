...
-- =========================
-- PROCEDURE: Atualizar Quantidade do Produto
-- =========================
...
-- =========================
-- FUNCTION: Calcular total com IVA
-- =========================
...
-- =========================
-- TRIGGER: Verificar estoque após encomenda
-- =========================
...
-- =========================
-- TRIGGER: Ativar/Inativar produto baseado em estoque
-- =========================
...
-- =========================
-- TRIGGER: Log de atualização de Produto
-- =========================
...
-- =========================
-- TESTES FINAIS (CONSULTAS AUXILIARES)
-- =========================

SELECT * FROM vw_livros_ativos;
SELECT * FROM vw_encomendas_completas;
SELECT fn_preco_com_iva(100, 0.23) AS preco_com_iva;
CALL sp_atualizar_quantidade(1, 50);
...
-- =========================
-- USUÁRIOS ADICIONAIS E PRIVILÉGIOS
-- =========================
...
-- Permissões específicas para WEB_CLIENT
